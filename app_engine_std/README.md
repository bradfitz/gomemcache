...
### Using *go get*
    ...
    $ go get github.com/briankovacs-roi/gomemcache/app_engine_std

After this command *gomemcache* is ready to use. Its source will be in:

    $GOPATH/src/github.com/briankovacs-roi/gomemcache/app_engine_std

## Example

    import (
            "github.com/briankovacs-roi/gomemcache/app_engine_std"
    )
